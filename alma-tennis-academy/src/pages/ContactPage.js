        ...
        <div className="bg-white rounded-2xl shadow-md p-8">
          {submitted ? (
            <div className="text-center py-12">
              ...
              <p className="text-alma-charcoal/60">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  required
                  rows={5}
                  className="w-full px-4 py-3 rounded-lg border border-alma-cream-dark focus:border-alma-lime focus:ring-2 focus:ring-alma-lime/20 outline-none transition-all resize-none"
                />
              </div>
            ...
            {[
              {
                ...
                title: 'Address',
                detail: '123 Tennis Court Lane, Sport City, SC 12345',
              },
              {
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              },
              {
                ...
                title: 'Email',
                detail: 'info@almatennisacademy.com',
              },
              {
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                title: 'Hours',
                detail: 'Mon-Fri: 6AM-9PM | Sat-Sun: 7AM-7PM',
              },
            ].map(info => (
              <div key={info.title} className="flex items-start gap-4 bg-white rounded-xl p-5 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-alma-charcoal/60 mt-1">{info.detail}</p>
                </div>
              </div>
            ))}
          </div>
